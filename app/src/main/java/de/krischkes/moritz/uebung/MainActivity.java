...
public class MainActivity extends Activity {
    ...
    public void CheckboxEventHandler (View v){
        ...
        switch(v.getId()){
            case R.id.checkbox1:
                Log.d("MainActivity", "Checkbox 1 is clicked");
            ...
            case R.id.checkbox2:
                Log.d("MainActivity", "Checkbox 2 is clicked");
                if(((CheckBox)v).isChecked()){
            ...
            case R.id.checkbox3:
                Log.d("MainActivity", "Checkbox 3 is clicked");
                if(((CheckBox)v).isChecked()){
            ...
            case R.id.checkbox4:
                Log.d("MainActivity", "Checkbox 4 is clicked");
                if(((CheckBox)v).isChecked()){
            ...
            case R.id.checkbox5:
                Log.d("MainActivity", "Checkbox 5 is clicked");
                if(((CheckBox)v).isChecked()){
